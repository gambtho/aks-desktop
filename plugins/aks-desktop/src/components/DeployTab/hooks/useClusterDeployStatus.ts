...
export const ANNOTATION_DEPLOYED_BY = 'aks-desktop/deployed-by';
export const ANNOTATION_PIPELINE_REPO = 'aks-desktop/pipeline-repo';
export const ANNOTATION_PIPELINE_RUN_URL = 'aks-desktop/pipeline-run-url';
...
export const useClusterDeployStatus = (
  ...
  useEffect(() => {
    ...
    // Pattern matches useDeploymentHealth.ts.
    const setup = async () => {
      try {
