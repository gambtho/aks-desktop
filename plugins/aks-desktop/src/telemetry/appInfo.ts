...
export interface AppInfo {
  ...
  /**
   * Host arch parsed from `navigator.userAgent`. On macOS Apple Silicon the
   * legacy UA reports Intel for Chromium site-compat, so this returns `'x64'`
...
function parseArch(ua: string): AppInfo['arch'] {
